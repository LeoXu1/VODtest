            ...
            public void onStateChanged(int id, TransferState state) {
                if (TransferState.COMPLETED == state) {
                    ...
                    try {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(LiveStreamsActivity.this,
                        ...
                        streams.setOnItemClickListener((parent, view, position, id2) -> {
                            ...
                            Intent playDownloadIntent = new Intent(LiveStreamsActivity.this, LiveStreamPlayerActivity.class);
